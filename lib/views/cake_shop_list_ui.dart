...
class _CakeShopListUiState extends State<CakeShopListUi> {
  ...
  //ตัวเปรเก็บชื่อร้าน 7 ร้านที่จะใช้กับ ListView
      ...
      body: Center(
        child: Column(
          children: [
            ...
            //ส่วนของ ListView
            Expanded(
              //expanded คือการยึดพื้นที่ที่เหลือทั้งหมด
              child: ListView.separated(
                // จำนวนรายการใน ListView
                itemCount: cakeShops
                    .length, //ใช้ตัวแปรที่เก็บชื่อร้านเค้กมาเป็นจำนวนรายการใน ListView / ItemCount คือจำนวนรายการที่จะแสดงใน ListView
                //เส้นคั่นระหว่างรายการ
                separatorBuilder: (context, index) => Divider(
                  color: Colors.red[300],
                  thickness: 1, //ความหนาของเส้นคั่น
                  height: 40,
                ),
                ...
                itemBuilder: (context, index) => ListTile(
                  ...
                  trailing: Icon(
                    //ส่วนต่างหลังของแต่ละรายการ (ไอคอน)
                    Icons.info,
                    color: Colors.red,
                  ),
                  onTap: () {
